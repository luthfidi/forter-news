    ...
    <section className="px-4 md:px-6 pt-24 md:pt-32 pb-16 md:pb-20">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <p className="text-pretty mt-6 md:mt-8 text-lg md:text-xl text-muted-foreground leading-relaxed max-w-3xl mx-auto">
          Forter is the <span className="font-semibold text-foreground">Information Finance Protocol</span>. Back outcomes and the analysts who forecast them. Build portable, on-chain reputation with dynamic NFTs.
        </p>
